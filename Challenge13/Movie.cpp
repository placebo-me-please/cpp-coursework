...
void Movie::print_summary(){
    ...
    std::cout << "The name of the film is " << title << std::endl;
    std::cout << "The user has watched the film " << watch_count << " times" << std::endl;
    std::cout << "The user has given this film a rating of " << user_rating << std::endl;
}
